...
class VolunteerProfile(models.Model, Profile):
	...
	image = models.FileField(upload_to='static/media/volunteers/', blank=True, null=True)
...
class OrganisationProfile(models.Model, Profile):
	...
	image = models.FileField(upload_to='static/media/organisations', blank=True, null=True)
